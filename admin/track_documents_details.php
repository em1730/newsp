...
$track_document_sql = "SELECT docno, txndate, time, particulars, receiver, origin, destination, status, remarks FROM tbl_ledger WHERE docno = :doc ORDER BY txndate DESC,time DESC";
$track_document_data = $con->prepare($track_document_sql);
$track_document_data->execute([':doc' => $docno]);  
// while ($result = $track_document_data->fetch(PDO::FETCH_ASSOC)) {
//   $docno = $result['docno'];
     ...
     <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
              <h3 class="card-title"><strong>Document No. <?php echo $docno ?></strong> </h3>
            </div>
               <!-- Main content -->
...
<!-- row -->
<?php while($track_data = $track_document_data->fetch(PDO::FETCH_ASSOC)){ ?>  
<div class="row">
  <div class="col-md-12">
    <!-- The time line -->
    <ul class="timeline">
      ...
      <li class="time-label">
            <span class="bg-red">
              ...
              <?php if ($group_date !== substr($track_data['txndate'], 0, 10)) { ?>
              <?php $group_date = substr($track_data['txndate'], 0, 10); ?>
              <h1 style="font-size:15px;" ><strong>  <?php echo $group_date; ?> </strong></h1>
              <?php } ?>
            </span>
      </li>
      <!-- /.timeline-label -->
      <!-- timeline item -->
      <li>
      <?php if ($track_data['status'] == 'CREATED'){ ?>
              <i class="fa fa-pencil-square-o" aria-hidden = "true"></i>
      <?php }else if ($track_data['status'] == 'FORWARDED'){  ?>
           <i class="fa fa-share" aria-hidden = "true"></i>
      <?php }else if ($track_data['status'] == 'RECEIVED'){  ?>
      ...
      <?php }  ?>
        ...
        <div class="timeline-item">
          <span class="time"><i class="fa fa-clock-o"></i> <?php echo $track_data['time']; ?></span>
        
      <?php if ($track_data['status'] == 'CREATED'){ ?>
              <h3  class="timeline-header"> <strong> <?php echo $track_data['status'];  ?>  at <?php echo $track_data['origin'] ;?> and FORWARDED to  <?php echo $track_data['destination'] ;?> by <?php echo $track_data['receiver'];?> </strong> </h3>
      <?php }else if ($track_data['status'] == 'FORWARDED'){  ?>
              <h3 class="timeline-header"> <strong> <?php echo $track_data['status'];  ?> from <?php echo $track_data['origin'];?>  to <?php echo $track_data['destination'];?> by <?php echo $track_data['receiver'];?> </strong> </h3>
      <?php }else if ($track_data['status'] == 'RECEIVED'){  ?>
              <h3 class="timeline-header"> <strong> <?php echo $track_data['status'];  ?> at <?php echo $track_data['destination'];?> from <?php echo $track_data['origin'];?> by <?php echo $track_data['receiver'];?> </strong>  </h3>
      <?php }  ?>

          <div class="timeline-body">
          <h1 style="font-size:14px;" > <?php  echo "REMARKS: ".$track_data['remarks']; ?> </h1>
          </div>
