...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
       <h1 class="m-0 text-dark">Add Referral</h1>
      </div>
      <div class="col-sm-6">
         ...
         <form role="form" enctype="multipart/form-data" method="post" action="<?php htmlspecialchars("PHP_SELF"); ?>">
           <div class="card-body">
             ...
             <div class="row">
               ...
               <div class="col-md-10">
                 <textarea type="text" class="form-control" name="description" placeholder="Description" required><?php echo $description; ?></textarea>
               </div>
             </div><br>
             ...
             <div class="row">
               ...
               <div class="col-md-10">
               <select class="form-control select2" id ="office" style="width: 100%"; name="office"; ?>">
