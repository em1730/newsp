          ...
          <div class="col-md-2">
            ...
            <div class="card card-outline card-secondary">
              ...
              <div id="btngrp" class="collapse show btn-group-vertical">
                <a role="button" href="add_referral" class="btnOUT btn btn-info"><i class="fa fa-plus"></i> Add Referral</a>
          ...
          <div class="col-md-10">
            <div class="card card-outline card-primary">
              <div class="card-header with-border">
                <h3 class="card-title">List of Referrals</h3>
              </div>
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form" method="get" action="<?php htmlspecialchars("PHP_SELF"); ?>">
                <div class="card-body">
                  <table id="maintable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php while ($referral_data = $get_all_referrals_data->fetch(PDO::FETCH_ASSOC)) { ?>
                        <tr>
                          <td><?php echo ($referral_data['date_received']) ?></td>
                          <td><?php echo $referral_data['ref_no']; ?></td>
                          <td><?php echo $referral_data['office']; ?></td>
                          <td><?php echo $referral_data['description']; ?></td>
                          <td><?php echo $referral_data['agenda']; ?></td>
                          <td><?php if (empty($referral_data['Filenames'])) {
                                $btnhidden = "hidden";
                                $btnhidden2 = "";
                              } else {
                                $btnhidden = "";
                              ...
                              ?>
                            <a class="btn btn-outline-success btn-sm" href="update_ordinances.php?orno=<?php echo $referral_data['OrdinanceNumber']; ?>" data-toggle="tooltip" data-placement="top" title="Update Ordinance"><i class="fa fa-pencil"></i></a>
                            ...
                            <a <?php echo $btnhidden ?> class="btn btn-outline-success btn-sm" href="view_pdf.php?orno=<?php echo $referral_data['OrdinanceNumber']; ?>" data-toggle="tooltip" data-placement="top" title="View Scanned Ordinance"><i class="fa fa-search"></i></a>
                            <button <?php echo $disablebutton; ?> class="btn btn-outline-danger btn-sm" data-role="confirm_delete" data-id="<?php echo  $referral_data["OrdinanceNumber"]; ?>" data-toggle="tooltip" data-placement="top" title="Delete Ordinance"><i class="fa fa-trash-o"></i></button>
